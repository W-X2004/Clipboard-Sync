...
| 组件 | 说明 |
|------|------|
| Python 3.8+ | 两台电脑都要装，并勾选 “Add to PATH” |
| 依赖 | `pip install pystray pillow`（pyperclip 已内置） |

## 快速开始

### 1. 服务端电脑

双击 `start_tray_server.bat`，或命令行：
